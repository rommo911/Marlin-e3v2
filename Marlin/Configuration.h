...
#define CUSTOM_MACHINE_NAME "Ender-3 V2-02-04-25"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    // Ender 3 v2 // new bambulab extruder 
    #define DEFAULT_Kp  9.7
    #define DEFAULT_Ki   1.84
    #define DEFAULT_Kd  12.8
  #endif
#else
...
#define PIDTEMPBED
  ...
  // Ender 3 V2
  #define DEFAULT_bedKp 124.7
  #define DEFAULT_bedKi  20.0
  #define DEFAULT_bedKd 519.04
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 137 } // Ender 3 V2 dual extruder
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 800, 800, 15, 35 } // improved speed 
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 900, 900, 200, 1000 }
 ...
 */
#define CLASSIC_JERK
#if ENABLED(CLASSIC_JERK)//ender 3v2 
...
#define Z_PROBE_FEEDRATE_FAST (2*50) // (mm/min)
 ...
 */
#define Z_IDLE_HEIGHT Z_HOME_POS + 1
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 23 // 23 is the offset of the nozzle ourtside the bed for BL touch reach further 
#define Y_MAX_POS Y_BED_SIZE  
#define Z_MAX_POS 180 // size after upgrade 
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 40), (Y_MAX_POS - 40), 50 }
